...
4. Loads each origin's `/_rendermesh/edge.yaml`.
...
This means changes to `/_rendermesh/edge.yaml` and HTML templates become active after the next successful sync.
